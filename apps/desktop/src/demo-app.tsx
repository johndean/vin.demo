/* demo.vin — mock target product the consultant drives on stage (always light, own
   identity). Ported 1:1 from desktop/demo-app.jsx. */

export function DemoApp({ screen }: { screen: string }) {
  return (
    <div className="pa">
  ...
  return (
    <>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 14, marginBottom: 18 }}>
        {([['Pending approval', '12', '#9a6b1a'], ['Approved today', '34', '#1f7a52'], ['Avg. cycle time', '1.8d', '#283e5b']] as [string, string, string][]).map(([l, v, c]) => (
      ...
      <div className="pa-card">
        ...
        {([['REQ-4821', 'Supply restock', 'K. Alvarez', '$3,240', 'pending'], ['REQ-4820', 'Equipment', 'M. Singh', '$11,500', 'pending'], ['REQ-4818', 'Software seats', 'T. Okafor', '$2,100', 'approved']] as string[][]).map((r) => (
  ...
  return (
    <>
      ...
      <div className="pa-card">
        ...
        {([['REQ-4821 · Supply restock', 'S. Albright (Owner)', 'Tier 2'], ['REQ-4820 · Equipment', 'R. Vance (Exec)', 'Tier 3'], ['REQ-4817 · Maintenance', 'P. Raman (Mgr)', 'Tier 1']] as string[][]).map((r) => (
    ...
    <>
      ...
      <div className="pa-card" style={{ padding: 18 }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          {([['Tier 1 — up to $1,000', 'Manager'], ['Tier 2 — up to $10,000', 'Owner / delegate'], ['Tier 3 — above $10,000', 'Executive + Owner']] as string[][]).map((r) => (
  ...
  return (
    <>
      ...
      <div className="pa-card">
        ...
        {([['09:41', 'Delegation created · Owner → Executive', 'S. Albright'], ['09:38', 'REQ-4818 approved (delegated)', 'R. Vance (for S. Albright)'], ['08:12', 'Threshold rule updated · Tier 2', 'Admin']] as string[][]).map((r) => (
