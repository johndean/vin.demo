/* VoiceClient — browser side of the voice channel. Captures mic audio, downsamples to 16 kHz
   ...
   the mic stops any in-progress playback. Pure Web APIs — identical copy in apps/web. */
...
export class VoiceClient {
  ...
  private mseEnsure(): boolean {
    ...
    try {
      ...
      this.mse = st;
      void el.play().catch(() => {}); // Electron autoplay is allowed; a deferred play is harmless
      return true;
