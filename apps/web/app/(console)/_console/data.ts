/* VIN Demo — shared demo dataset (ported 1:1 from VIN Demo/web/data.js).
   The portfolio VIN Demo can demonstrate is VIN's software suite; prospects are
   departments evaluating the products. */

const products = [
  { id: 'demo', name: 'demo.vin', domain: 'demo.vin', tagline: 'Approvals & requests', version: '3.4', versions: ['3.4 (current)', '3.3', '3.2', '3.1'], mk: 'DV', color: '#002855', status: 'Ready', coverage: 93, chunks: 1342, demos: 52, kbValidated: 88, kbReview: 8, kbStale: 4, env: 'demo-04', envStatus: 'Healthy', lastReset: '1h ago', graphNodes: 41, graphFlows: 7 },
  { id: 'expense', name: 'expense.vin', domain: 'expense.vin', tagline: 'Staff expense capture & reimbursement', version: '2.1', versions: ['2.1 (current)', '2.0', '1.9'], mk: 'EX', color: '#0097A9', status: 'Ready', coverage: 81, chunks: 690, demos: 23, kbValidated: 76, kbReview: 15, kbStale: 9, env: 'expense-demo-02', envStatus: 'Healthy', lastReset: '4h ago', graphNodes: 26, graphFlows: 4 },
  { id: 'ce', name: 'ce.vin', domain: 'ce.vin', tagline: 'Continuing-education credits & compliance tracking', version: '5.0', versions: ['5.0 (current)', '4.8', '4.7'], mk: 'CE', color: '#007D61', status: 'Ready', coverage: 87, chunks: 910, demos: 31, kbValidated: 82, kbReview: 12, kbStale: 6, env: 'ce-demo-01', envStatus: 'Healthy', lastReset: '1d ago', graphNodes: 33, graphFlows: 5 },
  { id: 'rounds', name: 'rounds.vin', domain: 'rounds.vin', tagline: 'Case rounds & team discussion boards', version: '1.6', versions: ['1.6 (current)', '1.5'], mk: 'RD', color: '#4D6995', status: 'Training', coverage: 58, chunks: 402, demos: 6, kbValidated: 49, kbReview: 34, kbStale: 17, env: 'rounds-demo-01', envStatus: 'Reset pending', lastReset: '5d ago', graphNodes: 18, graphFlows: 3 },
  { id: 'modelcontract', name: 'modelcontract.software', domain: 'modelcontract.software', tagline: 'Employment-contract builder + embeddable wizard', version: '4.0', versions: ['4.0 (current)', '3.9', '3.8'], mk: 'MC', color: '#0861CE', status: 'Ready', coverage: 79, chunks: 558, demos: 14, kbValidated: 70, kbReview: 20, kbStale: 10, env: 'mc-demo-03', envStatus: 'Healthy', lastReset: '2d ago', graphNodes: 22, graphFlows: 4 },
  { id: 'defensive', name: 'defensive.software', domain: 'defensive.software', tagline: 'Defensible record documentation', version: '2.3', versions: ['2.3 (current)', '2.2'], mk: 'DF', color: '#B9975B', status: 'Training', coverage: 47, chunks: 240, demos: 3, kbValidated: 38, kbReview: 40, kbStale: 22, env: 'defensive-demo-01', envStatus: 'Reset pending', lastReset: '8d ago', graphNodes: 14, graphFlows: 2 },
];
...
const kbTypes: Record<string, { label: string; cls: string }> = {
...
const evals = [
  { id: 'e1', name: 'Intent recognition', score: 0.94, target: 0.9, runs: 312, trend: 'up' },
...
export const VD = { products, knowledge, kbTypes, personas, stakeholders, customers, sessions, evals, costBreakdown };
export type VDType = typeof VD;
