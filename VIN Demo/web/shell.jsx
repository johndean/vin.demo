/* VIN Demo — shared icon set + console shell primitives.
   NOTE: the VIN design system ships 12 product icons but no nav/section
   icons; per its guidance these are closest-match placeholders in one
   coherent stroke style, pending authentic VIN icons. */
...
function Icon({ name, size = 16, fill = false, style, cls }) {
...
function Metric({ label, value, delta, dir = "flat", spark }) {
  return (
...
function Sparkline({ points, dir, className }) {
  const w = 72, h = 26;
    ...
    <nav className="sidebar scroll">
      ...
      <div className="sidebar__foot">
        <div className="mode-card">
          ...
          <div className="mode-card__row" style={{ marginTop: 6, justifyContent: "space-between" }}>
...
Object.assign(window, { React, useState, useEffect, useRef, useMemo, Icon, ICONS, Pill, ModeChip, MODE_META, ConfBar, VALIDATION, Metric, Sparkline, Avatar, Topbar, Sidebar, NAV });
